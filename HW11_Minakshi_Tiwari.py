...
class University:
    ...
    def __init__(self, dir: str, header=True,db_path:str):
        ...
        try:
            self._student_summaty_grade(os.path.join(dir, self.db_path))
...
def main():
    ...
    University(True,'/Users/minakshitiwari/Documents/MS Courses/810-Special Topics in Software Engineering./Week eleven','jetbrains://dbe/navigate/reference?project=810-Special Topics in Software Engineering.&path=Week eleven/Tuesday_day.sqlite')
