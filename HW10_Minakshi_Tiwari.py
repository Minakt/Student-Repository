...
class Student:
    ...
    def __init___(self, cwid: str, name: str, major: str) -> None:
    ...
    def info(self):
        ...
        major, passed, remaining_courses, electives_courses = self._major.remaining_courses(
            self._courses)
        return [self._cwid, self._name, major, self.gpa(), sorted(passed), sorted(remaining_courses), sorted(electives_courses)]
...
class Major:
    PT_FIELD_NAMES3 = ['Major', 'Required Courses',
                       'Remaining Courses', 'Electives Courses']
...
class University:
    ...
    def __init__(self, dir: str, header=True):
